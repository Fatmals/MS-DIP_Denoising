...
def skip(
        ...
        num_channels_down=[16, 32, 64, 64, 128], num_channels_up=[16, 32, 64, 64, 128], num_channels_skip=[4, 4, 4, 4, 4], #before [16, 32, 64, 128, 128]
...
def multi_scale_skip(input_depth, num_output_channels, scales, pad='reflection'):
    ...
    for scale in scales:
        model = skip(
            ...
            num_channels_down=[8, 16, 32, 32, 64], #before [8, 16, 32, 64, 128]

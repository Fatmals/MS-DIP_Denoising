...
def skip(
        ...
        num_channels_down=[16, 32, 64, 128, 128], num_channels_up=[16, 32, 64, 128, 128], num_channels_skip=[0, 0, 0, 4, 4], #before [16, 32, 64, 128, 128] and num_channels_skip=[4, 4, 4, 4, 4]

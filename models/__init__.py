...
from .multi_scale_dip import MultiScaleNetwork  # Import the MultiScaleNetwork
...
def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3, act_fun='LeakyReLU', skip_n33d=128, skip_n33u=128, skip_n11=4, num_scales=5, downsample_mode='stride'):
    if NET_TYPE == 'ResNet':
        ...
        net = UNet(num_input_channels=input_depth, num_output_channels=n_channels, 
        ...
        net = MultiScaleNetwork(num_input_channels=input_depth, num_output_channels=n_channels, 

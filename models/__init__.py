...
from .multi_scale_unet import MultiScaleUNet  # Ensure this is correctly imported
...
def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3, act_fun='LeakyReLU', skip_n33d=128, skip_n33u=128, skip_n11=4, num_scales=5, downsample_mode='stride'):
    if NET_TYPE == 'ResNet':
    ...
    elif NET_TYPE == 'MultiScaleUNet':  # This is new
        net = MultiScaleUNet(num_input_channels=input_depth, num_output_channels=3,
                             ...
                             pad=pad, norm_layer=nn.BatchNorm2d, 

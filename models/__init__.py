...
def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3, act_fun='LeakyReLU', 
    ...
    elif NET_TYPE == 'MultiScaleUNet':  # Add this block for MultiScaleUNet
        net = MultiScaleUNet(num_input_channels=input_depth, num_output_channels=3,
                             feature_scale=4, scales=scales, upsample_mode=upsample_mode,
                             pad=pad, norm_layer=nn.BatchNorm2d, need_sigmoid=True, need_bias=True)
